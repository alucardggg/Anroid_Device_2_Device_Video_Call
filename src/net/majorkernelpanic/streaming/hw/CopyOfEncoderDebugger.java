 ...
 */
@SuppressLint("NewApi")
public class CopyOfEncoderDebugger {
	...
	public synchronized static CopyOfEncoderDebugger debug(Context context, int width, int height) {
		SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
		return debug(prefs, width, height);
	}

	public synchronized static CopyOfEncoderDebugger debug(SharedPreferences prefs, int width, int height) {
		CopyOfEncoderDebugger debugger = new CopyOfEncoderDebugger(prefs, width, height);
		debugger.debug();
		return debugger;
	}
	...
	private CopyOfEncoderDebugger(SharedPreferences prefs, int width, int height) {
		mPreferences = prefs;
		mWidth = width;
		mHeight = height;
		mSize = width*height;

...
import net.majorkernelpanic.streaming.video.VideoStream_Test;
...
public class H264Packetizer extends AbstractPacketizer implements Runnable {
	...
	public void run() {
		...
		if (is instanceof MediaCodecInputStream) {
			...
			streamType = 0;	
			socket.setCacheSize(500);
		}

		try {
			while (!Thread.interrupted()) {

				oldtime = System.nanoTime();//-1000000000L;
...
//			Log.e("AAAAAAAA=>",((MediaCodecInputStream)is).getLastBufferInfo().presentationTimeUs+"");
//			Log.e("BBBBBBBB=>",((MediaCodecInputStream)is).getLastBufferInfo().presentationTimeUs+" || " + System.currentTimeMillis());
//			Log.e("CCCCCCCC=>",(((MediaCodecInputStream)is).getLastBufferInfo().presentationTimeUs*1000L/100L)*(90000/1000L)/10000L+"");
			//ts += delay;
...
//			header[0] = (byte) ((header[4] & 0xE0) & 0xFF); // alucard
